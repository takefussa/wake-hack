...
const styles = StyleSheet.create({
  ...
  refreshButton: { width: 44, height: 44, alignItems: 'center', justifyContent: 'center', borderWidth: 1, borderColor: paperColors.ink, backgroundColor: paperColors.base, borderRadius: 10 },
